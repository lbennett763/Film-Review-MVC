...
namespace FilmReview_MVC_Website.Controllers
{
    ...
    {
        private AgeRatingContext db = new AgeRatingContext();
        ...
        public ActionResult Create([Bind(Include = "AgeRatingID,AgeRatingName")] AgeRating ageRating)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AgeRatingID,AgeRatingName")] AgeRating ageRating)
        {
            if (ModelState.IsValid)
            {
